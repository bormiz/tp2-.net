...
namespace CinemaManager_ahmedazizbenayed.Models.Cinema;
...
public partial class CinemaDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Movie__3214EC073033B308");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Producer__3214EC072C5404C9");
